...
export function OrganizationsDeleteDialog({
  ...
  const handleDelete = () => {
    ...
    showSubmittedData(
      currentRow,
      'The following organization has been deleted:'
    )
  }
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            ...
            <br />
            This action will permanently remove the organization from the
          ...
          <Label className='my-2'>
            ...
            <Input
              ...
              placeholder='Enter organizationName to confirm deletion.'
            />
          </Label>
