...
type RoleInviteDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function RolesInviteDialog({
  open,
  onOpenChange,
}: RoleInviteDialogProps) {
      ...
      <DialogContent className='sm:max-w-md'>
        <DialogHeader className='text-start'>
          <DialogTitle className='flex items-center gap-2'>
            <MailPlus /> Invite Role
          </DialogTitle>
          <DialogDescription>
            Invite new role to join your team by sending them an email
