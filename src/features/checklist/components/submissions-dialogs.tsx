import { useDeleteChecklistSubmission } from '@/hooks/use-checklist-submissions'
...
export function SubmissionsDialogs({ formId }: FormsDialogsProps) {
  ...
  const deleteFormSubmission = useDeleteChecklistSubmission()
      ...
      {currentRow && (
        <>
          ...
          <ConfirmDialog
            ...
            desc={
              <>
                You are about to delete a checklist submission{' '}
