...
const route = getRouteApi('/_authenticated/policy/$policyId')

type DataTableProps = {
  data: any
}

export function PolicyVersions({ data }: DataTableProps) {
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, _columnId, filterValue) => {
      ...
      const title = String(row.getValue('name')).toLowerCase()
